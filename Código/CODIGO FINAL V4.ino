...
void loop() {
  ...
  if(contador>0 & tiempo4-tiempo3>10000){ //en este caso puse 10  segundos para ver si funciona pero en realidad debe ser 15 min y de ahi recien sonar
    tone(buzzer,660,1000);
  }
